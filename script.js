...
document.querySelectorAll(".elum").forEach(function (elum) {
  var rotate = 0;
  var diffrot = 0;

  elum.addEventListener("mouseleave", function (dets) {
    gsap.to(elum.querySelector("img"), {
      opacity: 0,
      ease: Power3,
      duration: 0.5,
    });
  ...
  elum.addEventListener("mousemove", function (dets) {
    var diff = dets.clientY - elum.getBoundingClientRect().top;
